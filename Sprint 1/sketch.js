...
function setup() {
    ...
    song2 = createAudio('assets/assets_sounds_confetti.mp3');
...
function playClay() {
    song2.loop(); 
    fill(230, 230, 150, 127);  
    // textAlign(CENTER); 
    ellipse(mouseX, 200, 150, 200);    // Top circle
  ellipse(mouseX/20, 150, 100, 150); // Middle circle
  ellipse(mouseX*20, 150, 100, 200); 
